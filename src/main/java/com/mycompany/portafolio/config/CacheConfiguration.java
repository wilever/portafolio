package com.mycompany.portafolio.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("portafolio");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("portafolio");
        ...
        config.getMapConfigs().put("com.mycompany.portafolio.domain.*", initializeDomainMapConfig(jHipsterProperties));
