...
export class SocialAccountComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.socialAccountService
            ...
            .subscribe(
                (res: HttpResponse<ISocialAccount[]>) => this.paginateSocialAccounts(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/social-account'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ISocialAccount) {
        return item.id;
    }
    ...
    protected paginateSocialAccounts(data: ISocialAccount[], headers: HttpHeaders) {
