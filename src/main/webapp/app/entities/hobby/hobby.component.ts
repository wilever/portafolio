...
export class HobbyComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.hobbyService
            ...
            .subscribe(
                (res: HttpResponse<IHobby[]>) => this.paginateHobbies(res.body, res.headers),
    ...
    trackId(index: number, item: IHobby) {
        return item.id;
    }
    ...
    protected paginateHobbies(data: IHobby[], headers: HttpHeaders) {
