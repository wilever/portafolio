...
import { AboutMeComponent } from 'app/entities/about-me/about-me.component';
import { AboutMeService } from 'app/entities/about-me/about-me.service';
import { AboutMe } from 'app/shared/model/about-me.model';

describe('Component Tests', () => {
    describe('AboutMe Management Component', () => {
        let comp: AboutMeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AboutMeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.aboutMes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
