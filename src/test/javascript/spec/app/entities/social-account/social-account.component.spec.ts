...
import { SocialAccountComponent } from 'app/entities/social-account/social-account.component';
...
describe('Component Tests', () => {
    describe('SocialAccount Management Component', () => {
        let comp: SocialAccountComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SocialAccountComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.socialAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
