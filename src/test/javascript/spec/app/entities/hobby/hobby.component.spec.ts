...
import { HobbyComponent } from 'app/entities/hobby/hobby.component';
import { HobbyService } from 'app/entities/hobby/hobby.service';
import { Hobby } from 'app/shared/model/hobby.model';

describe('Component Tests', () => {
    describe('Hobby Management Component', () => {
        let comp: HobbyComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HobbyComponent, '')
                .compileComponents();
