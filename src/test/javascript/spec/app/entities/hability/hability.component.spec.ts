...
import { HabilityComponent } from 'app/entities/hability/hability.component';
...
describe('Component Tests', () => {
    describe('Hability Management Component', () => {
        let comp: HabilityComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HabilityComponent, '')
                .compileComponents();
