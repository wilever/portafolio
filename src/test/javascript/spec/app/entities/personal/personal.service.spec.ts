...
describe('Service Tests', () => {
    describe('Personal Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Personal(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'image/png', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Personal', async () => {
                const returnedFromService = Object.assign(
                    {
                        firstName: 'BBBBBB',
                        lastName: 'BBBBBB',
            ...
            it('should delete a Personal', async () => {
